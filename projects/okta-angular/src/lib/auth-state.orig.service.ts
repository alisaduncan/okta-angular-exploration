...
// this is the exact original implementation for testing with the OktaAuthOrigModule.forRoot example
...
@Injectable()
export class OktaAuthStateOrigService implements OnDestroy {
